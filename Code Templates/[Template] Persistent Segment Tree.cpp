/*
	...
	Space Complexity : O(N + QlogN)
	Use vector container. code from https://github.com/green5555/Teamnote/blob/master/TeamNote/PST.cpp

	Template's main() code is solution of BOJ problem 11012
*/
